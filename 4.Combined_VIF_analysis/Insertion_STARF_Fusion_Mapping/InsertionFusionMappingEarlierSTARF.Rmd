...
CCLE_fusion_data = read.table(gzfile("../../3.InsertionCatalog/CCLE_VIF_analysis/data/CCLE.starF.consolidated.Mar2019.tsv.gz"), header=T, sep="\t", stringsAsFactors = F, com='') %>%
