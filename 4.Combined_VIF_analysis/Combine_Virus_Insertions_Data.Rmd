...
Curie_virus_insertions = read.table("../InstitutCurie/insertions.tsv", header=T, sep="\t", stringsAsFactors = F)


Curie_virus_insertions = Curie_virus_insertions %>% rename(tissue = tissue_id)  %>%
