...
# turn off outliers and remove log y-scale

combined_data %>% ggplot(aes(x=virus, y=copy_number, fill=type)) + geom_boxplot(outlier.shape = NA) +
    theme_bw() +
   theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
    #scale_y_continuous(trans='log10')  +
    #ylim(0.5, 11) +
