...
hotspot_info = read.table("plot.hotspots.win_4e5.tsv.w_20_neighbors.hotspot_virus_sample_counts.tsv", header=T, sep="\t", stringsAsFactors = F)
...
hotspot_insertions = read.table("hotspots.win_4e5.tsv.w_20_neighbors", header=T, sep="\t", stringsAsFactors = F)
...
insertion_hotspot_assignments = read.table("hotspots.win_4e5.tsv", header=T, sep="\t", stringsAsFactors = F)


```

```{r}
hotspot_info_top_with_insertions = left_join(hotspot_info_top,
...
cnv_info = read.table(gzfile("../Insertion_and_CNVs/TCGA_insertions_and_CNV_within10kb.gz"), header=T, sep="\t", stringsAsFactors = F)
