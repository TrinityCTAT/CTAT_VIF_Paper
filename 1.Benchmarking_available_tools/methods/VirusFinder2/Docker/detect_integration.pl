...
sub RunCREST {
    ...
    if (!-e "$output_dir/crest/alignment.sorted.bam.cover"){
       `perl $CREST_dir/extractSClip.pl -i $output_dir/alignment.sorted.bam -o $output_dir/crest/ --ref_genome $output_dir/hg19+virus.fa`;
    }
    ...
    if ($paired){
    	if($mode eq 'normal'){
            ...
            `perl $ILIBs $CREST_dir/CREST.pl -f $output_dir/crest/alignment.sorted.bam.cover -d $output_dir/alignment.sorted.bam --ref_genome $output_dir/hg19+virus.fa --boundary $output_dir/SVDetect/results-virus-loci.txt -t $output_dir/crest/hg19+virus.2bit -s $output_dir/crest/virus.2bit --cap3 $cap3_bin --blat $blat_bin -l $read1_len -o $output_dir/crest/ -p results --rmdup`;
        }else{
    	...
    	if($mode eq 'normal'){
            `perl $ILIBs $CREST_dir/CREST.pl -f $output_dir/crest/alignment.sorted.bam.cover -d $output_dir/alignment.sorted.bam --ref_genome $output_dir/hg19+virus.fa --nopaired -t $output_dir/crest/hg19+virus.2bit -s $output_dir/crest/virus.2bit --cap3 $cap3_bin --blat $blat_bin -l $read1_len -o $output_dir/crest/ -p results --rmdup`;
        }else{
            #`perl CREST.pl -f $output_dir/crest/alignment.sorted.bam.cover -d $output_dir/alignment.sorted.bam --ref_genome $output_dir/hg19+virus.fa --boundary $output_dir/SVDetect/results-virus-loci.txt -t $output_dir/crest/hg19+virus.2bit -s $output_dir/crest/virus.2bit --cap3 $cap3_bin --blat $blat_bin -o $output_dir/crest/ -p results --rmdup --min_sclip_reads 1`;#  --sensitive
            `perl $ILIBs $CREST_dir/CREST.pl -f $output_dir/crest/alignment.sorted.bam.cover -d $output_dir/alignment.sorted.bam --ref_genome $output_dir/hg19+virus.fa --nopaired -t $output_dir/crest/hg19+virus.2bit -s $output_dir/crest/virus.2bit --cap3 $cap3_bin --blat $blat_bin -l $read1_len -o $output_dir/crest/ -p results --rmdup  --sensitive`;
        }
    }
