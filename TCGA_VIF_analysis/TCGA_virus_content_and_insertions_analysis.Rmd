...
TCGA_rnaseq_sample_align_stats = read.table("TCGA_rnaseq_sample_align_stats.tsv", header=T, sep="\t", stringsAsFactors = F)
...
insertions_data = read.table(gzfile("data/TCGA.VIF.refined_results.agg.tsv.gz"), sep="\t", stringsAsFactors = F, header=T, com='')
...
```{r}
virus_content_data = read.table(gzfile("data/TCGA.VIF.virus_reports.agg.tsv.gz"), header=T, sep="\t", stringsAsFactors = F, com='')
