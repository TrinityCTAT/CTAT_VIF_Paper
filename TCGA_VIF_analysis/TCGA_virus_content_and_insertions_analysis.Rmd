...
contaminants_info = read.table("Find_Likely_Contaminants/TCGA_VIF_contaminants_only.tsv", header=T, sep="\t", stringsAsFactors = F) %>% select(sample_name, virus, CONTAM) %>% unique()
