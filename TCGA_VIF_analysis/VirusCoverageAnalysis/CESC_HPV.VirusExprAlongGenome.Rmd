...
pdf("CESC_HPV_genome_coverage.pdf")
...
for (virus in viruses) {
  ...
  virus_coverage_matrix_filename = paste0("CESC.", virus, ".coverage.matrix")
  ...
  sample_insertion_labeling_filename = paste0("CESC.", virus, ".insertion_labeling.tsv")
