...
write.table(merged_distilled_report, file='GTEx.filtered_K113_content_and_insertions.distilled.tsv', quote=F, sep="\t", row.names=F)
...
ggsave(gtex_virus_content_summary_plot, file="GTEx_K113_summary_plot.pdf", width=12, height=12)
...
```{r}
ggsave(virus_median_mapped_all_plot, file="GTEx_K113_median_mapped_all_plot.pdf", width=16, height=12)
