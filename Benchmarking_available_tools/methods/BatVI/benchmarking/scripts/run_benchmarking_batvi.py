...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Reformat and benchmark VirusFinder2 output for benchamrking.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument(
        "--Directory", type=str, required=True, help="Directory of the BATVI output."
    )
    parser.add_argument(
        "--insertion_truth_set",
        type=str,
        required=True,
        help="insertion truth set file.",
    )
    parser.add_argument(
        "--viruses",
        type=list,
        required=False,
        default=["HPV45", "HPV39", "HPV33", "HPV16", "HPV31", "HPV18", "HPV35"],
        help="Virus identified.",
    )
